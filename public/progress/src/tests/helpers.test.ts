...
describe('deload prescription', () => {
  beforeAll(async () => {
    ...
    const ex: Exercise = { id: 'e1', name: 'Bench', muscleGroup: 'chest', defaults: { sets: 4, targetRepRange: '8-12' } }
    await db.put('exercises', ex)
    await db.put('sessions', {
      id: '1-1-0', dateISO: new Date().toISOString(), weekNumber: 1, phase: 1, entries: [
        { id: 'se1', exerciseId: 'e1', sets: [ { setNumber:1, weightKg:100, reps:8 }, { setNumber:2, weightKg:100, reps:8 } ] }
      ]
    })
  })
