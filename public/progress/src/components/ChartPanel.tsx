...
import { LineChart, Line, ResponsiveContainer, XAxis, YAxis, CartesianGrid, Tooltip, Scatter, ScatterChart } from 'recharts'
...
export default function ChartPanel({ kind }: { kind: 'exercise'|'measurement' }){
  const [exercises, setExercises] = useState<Exercise[]>([])
  const [measurementKey, setMeasurementKey] = useState<keyof Measurement>('waist')
  ...
  const d = await getMeasurementTimeSeries(measurementKey, range) as MeasurementPoint[]
      setData(d)
