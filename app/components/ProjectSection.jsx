      ...
      <div className="relative z-10 p-6 flex flex-col h-full">
        ...
        <div className="flex items-start justify-between mb-4">
          <motion.div
            ...
            className="p-3 rounded-xl bg-gradient-to-br from-primary-500/20 to-accent-500/20 text-2xl"
          >
        ...
        <div className="flex flex-wrap gap-2 mb-6">
          {project.tech.map((item, i) => (
            <motion.span
              ...
              className="px-3 py-1 text-xs font-medium rounded-full glass border border-primary-500/20 text-primary-400 hover:border-primary-500/50 transition-colors"
            >
              {item}
            </motion.span>
          ))}
        ...
        <div className="flex items-center gap-3 mt-auto">
          <Link
            ...
            className="group/btn flex-1 flex items-center justify-center gap-2 px-4 py-2.5 rounded-xl glass border border-white/10 text-slate-300 hover:text-white hover:border-primary-500/50 transition-all duration-300"
          >
...
const ProjectsSection = () => {
  ...
  return (
    ...
    >
      ...
      <div className="absolute top-1/3 -right-32 w-96 h-96 bg-accent-500/10 rounded-full filter blur-3xl" />
      <div className="absolute bottom-1/3 -left-32 w-96 h-96 bg-primary-500/10 rounded-full filter blur-3xl" />
        ...
        {filteredProjects.length > 6 && (
          ...
          >
            <motion.button
              ...
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
              className="inline-flex items-center gap-2 px-6 py-3 rounded-xl glass border border-white/10 text-slate-300 hover:text-white hover:border-primary-500/50 transition-all duration-300"
            >
