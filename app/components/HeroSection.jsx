...
const HeroSection = () => {
  ...
  return (
    <section id="home" className="min-h-[90vh] lg:py-16 relative overflow-hidden flex items-center">
      ...
      <motion.div 
        ...
        initial="hidden"
        animate="visible"
        className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 relative z-20 w-full"
      >
        {/* Text Content */}
